          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div data-reveal className="lg:col-span-6 space-y-4">
              ...
              <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
                Design impactful visuals that attract customers and drive
                meaningful business success. Enhance brand recognition,
                engagement, and business growth effortlessly.
              </p>
            </div>
          </div>
        </div>
