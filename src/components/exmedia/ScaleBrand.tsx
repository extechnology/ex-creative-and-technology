          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div data-reveal className="lg:col-span-6 space-y-4">
              <h3 className="font-display text-2xl sm:text-4xl lg:text-6xl font-medium text-white/95">
                Scale Your Brand, Grow Beyond Limits{" "}
              </h3>

              <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
                Increase engagement, conversions, and revenue with expert
                digital marketing. Strengthen your brand presence while
